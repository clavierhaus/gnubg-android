# Curated: timing.hold.crunch
Signature (measured; tools/harvest/signatures.py): context me I_BACKG1 > 0
both boards (exactly one rear anchor -- the holding-game gate, mutually
exclusive with backgame's I_BACKG) · veto me I_CONTAIN best <= 0.84 (a
...
- [a20l3h11] "Crunching your home board too early burns the timing a holding game needs to wait for its shot."
...
Six drafts, uniform and on-signal. Cut: "needs rear checkers to stay back
as long as possible" and "keeping checkers mobile/moving" tails --
counsellor voice, criterion 5; a20l2h11's 22-word flag (dense but at the
length ceiling). "Crunch" kept: it is the standard term and none of the
drafts' sentences trace to a book phrasing on spot-read.
