...
- [a20-22l4h12] "Moving up costs timing reserve, and a backgame without timing collapses before it gets a shot."
...
Twelve drafts, all high-confidence, remarkably on-signal (the I_TIMING delta
plus the I_BACKG context read correctly in every one). Cut: "keep checkers
back until you can strike" and every "keep/hold back" tail -- counsellor
imperatives, criterion 5; a20-24l5h11's 24-word flag (over length target,
though dense and correct). "Moving up" phrasing verified against the pairs:
the played move does bury the spare forward -- not a hallucination.
