...
Cut: s5d3's flag described the BEST move (polarity inversion);
'Releasing the trapped checker undoes your prime; keep it locked...' --
counsellor tail. Praise deliberately none: this entry fires on bad/very bad
only. Three raws needed embedded-JSON extraction (prose preamble).
