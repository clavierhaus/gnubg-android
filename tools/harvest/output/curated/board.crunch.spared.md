...
- entering gets costlier against the connected board (opp.I_ENTER +0.109..+0.184)
- point count unchanged -- the quantized closure stays flat (the fingerprint vs board.close.entry)
- context: containment of the entering checkers jumps with structure (me.I_CONTAIN up to +0.333)
