...
"""Append (or replace) one build block in an F-Droid metadata recipe.
    ...
    tools/fdroid_recipe_append.py <recipe.yml> <versionName> <versionCode> <commit>

The recipe keeps every published version. The last block is copied, its
versionName / versionCode / commit replaced and any 'disable:' dropped; an
