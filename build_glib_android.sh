...
[built-in options]
c_args = ['-DANDROID', '-fPIC', '-Os', '-w', '-ffile-prefix-map=$GLIB_SRC=/glib', '-ffile-prefix-map=$PROJECT_ROOT=.', '-ffile-prefix-map=$NDK_ROOT=/ndk', '-Wno-builtin-macro-redefined', '-D__DATE__=', '-D__TIME__=', '-D__TIMESTAMP__=']
