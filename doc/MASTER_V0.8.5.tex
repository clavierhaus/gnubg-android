...
\hypersetup{
  ...
  linkcolor=ruleblue,
  urlcolor=ruleblue,
  pdftitle={GNU Backgammon Android Port -- MASTER v0.8.5},
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\color{gray}GNU Backgammon Android Port --- MASTER v0.8.5}
...
\section{GNU Backgammon Android Port --- MASTER v0.8.5}\label{gnu-backgammon-android-port-master-v085}
...
current state of the project as of v0.8.5. It is intended as a working
...
\subsection{5. Version v0.8.5 --- Milestone}\label{version-v085}

\subsubsection{5.1 Assessment}\label{assessment-v085}

Version v0.8.5 delivers a playable one-point game with correct gnubg
...
\emph{GNU Backgammon Android Port --- MASTER v0.8.5 --- clavierhaus.at
--- June 2026}
