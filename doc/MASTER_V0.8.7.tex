...
\hypersetup{
  ...
  linkcolor=ruleblue,
  urlcolor=ruleblue,
  pdftitle={GNU Backgammon Android Port -- MASTER v0.8.7},
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\color{gray}GNU Backgammon Android Port --- MASTER v0.8.7}
...
\section{GNU Backgammon Android Port --- MASTER v0.8.7}\label{gnu-backgammon-android-port-master-v085}
...
\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}
\emph{GNU Backgammon Android Port --- MASTER v0.8.7 --- clavierhaus.at
--- June 2026}
