...
\hypersetup{
  ...
  linkcolor=ruleblue,
  urlcolor=ruleblue,
  pdftitle={GNU Backgammon Android Port -- MASTER v0.9.1},
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\color{gray}GNU Backgammon Android Port --- MASTER v0.9.1}
...
\section{GNU Backgammon Android Port --- MASTER v0.9.1}\label{gnu-backgammon-android-port-master-v09}
...
\emph{GNU Backgammon Android Port --- MASTER v0.9.1 --- clavierhaus.at
--- June 2026}
